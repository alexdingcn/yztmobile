...
//	
//	$('#ResellerListscroll').on('scroll', function() {
//		LoadData();
//	})
//	$("#ResellerListscroll").bind("scroll", LoadData); //绑定下拉事件
//}
var resellerID = '0'; //全部
...
//		},
	...
	$(".zbtn").on('click', function() {
		...
		//		var States = $("#States").attr("value")
		//		var Pay = $("#Pay").attr("value")
		//		var Reseller = $("#Reseller").attr("value")
		//		var Resellertext = $("#Reseller .info").text();
		//		
		//		var txtCreateDate = $("#txtCreateDate").text() == "" ? "-1" : $("#txtCreateDate").text()
		//		var txtEndeDate = $("#txtEndeDate").text() == "" ? "-1" : $("#txtEndeDate").text()
		//		window.location = "order_list.html?id=" + orderState + "," + payState + "," + resellerID + "," + txtCreateDate + "," + txtEndeDate + "," + $('#txtreseller').text()
	})
...
//			},
//			onConfirm: function(result) {
//				$('#txtCreateDate').text(result[0].value + '-' + result[1].value + '-' + result[2].value);
//			},
//			id: 'datePicker'
//		});
